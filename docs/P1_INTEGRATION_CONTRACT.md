...
| `lst_anomaly_c` | Required | Float | degrees Celsius | Yes | P1 | Deviation from 2014-2023 historical baseline. |
| `source` | Required | String | N/A | No | P1 | E.g., "Landsat 8/9 C02 L2, Sentinel-2 SR, ESA WorldCover v200". |
| `satellite` | Required | String | N/A | No | P1 | E.g., "Multiple". |
...
| `resolution_m_source`| Required | Integer | metres | No | P1 | Usually 30 (representative base). |
...
| `ndvi_mean` | Optional | Float | N/A | Yes | P1 | From Sentinel-2 SR. |
| `ndbi_mean` | Optional | Float | N/A | Yes | P1 | From Sentinel-2 SR. |
| `ndwi_mean` | Optional | Float | N/A | Yes | P1 | From Sentinel-2 SR. |
| `land_cover_class` | Optional | String | N/A | Yes | P1 | From ESA WorldCover v200. |
