...
def preprocess_features(properties: P2InternalProperties) -> Dict[str, float]:
    """
    ...
    # LST: Assuming typical urban range 25C to 55C
    normalized_features['norm_lst_c'] = clip_and_scale(properties.lst_c, 25.0, 55.0)
    
    # LST Anomaly: Assuming 0C to 10C anomaly range is critical
    if properties.lst_anomaly_c is not None:
